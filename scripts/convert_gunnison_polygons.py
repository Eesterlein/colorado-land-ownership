...
output_csv = "data/gunnison_polygon_points.csv"
...
try:
    ...
    # Filter to only include specific land managers for Gunnison area
    gdf = gdf[gdf["MANAGER"].isin(["USFS - GUNN", "PRIVATE", "BLM"])]
    ...
    for i, row in gdf.iterrows():
        ...
        for poly_index, poly in enumerate(polygons):
            coords = list(poly.exterior.coords)[::3]  # Keep every 3rd point
